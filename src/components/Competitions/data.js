...
export const events = [
  ...
  },
  {
    ...
    "poster": require("./Innovative Model Compitition.png"),
    "structure": "MCKVIE Students: 100rs/Team, Outside Students: 200rs/Team [Note: Payments will be collected offline, on campus.]",
  ...
  },
  {
    ...
    "poster": require("./Tech Poster Presentation Flyer.png"),
    "structure": "MCKVIE Students: 100rs/Team, Outside Students: 200rs/Team [Note: Payments will be collected offline, on campus.]",
  ...
  },
  {
    ...
    "poster": require("./Code Fiesta Flyer 2.png"),
  ...
  },
  {
    ...
    "poster": require("./Catia-Autocad Flyer.png"),
    "structure": "MCKVIE Students: 50rs/Head, Outside Students: 100rs/Head [Note: Payments will be collected offline, on campus.]",
  ...
  },
  {
    ...
    "poster": require("./Circuit Design Flyer.png"),
  ...
  },
  {
    ...
    "poster": require("./Ml Mania Flyer.png"),
    "structure": "MCKVIE Students: 50rs/Head, Outside Students: 100rs/Head [Note: Payments will be collected offline, on campus.]",
  ...
  },
  {
    ...
    "poster": require("./Enigma Poster.png"),
    "payment" : "50inr",
    "structure": "MCKVIE Students: 50rs/Head, Outside Students: 50rs/Head [Note: Payments will be collected offline, on campus.]",
  ...
  },
  {
    ...
    "poster": require("./QuizoMania Poster.png"),
    "structure": "MCKVIE Students: 50rs/Head, Outside Students: 50rs/Head [Note: Payments will be collected offline, on campus.]",
  ...
  },
  {
    ...
    "poster": require("./Math Mania Flyer 2.png"),
    "structure": "MCKVIE Students: 50rs/Head, Outside Students: 100rs/Head [Note: Payments will be collected offline, on campus.]",
    ...
    "poster": require("./Need For Speed Poster.png"),
    "structure": "MCKVIE Students: 50rs/Head, Outside Students: 100rs/Head [Note: Payments will be collected offline, on campus.]",
    ...
    "poster": require("./Fifa Poster.png"),
    "structure": "MCKVIE Students: 50rs/Head, Outside Students: 100rs/Head [Note: Payments will be collected offline, on campus.]",
    ...
    "poster": require("./Robo Fifa Poster.png"),
    ...
    "poster": require("./Chase the Maze Poster.png"),
    "structure": "MCKVIE Students: 100rs/Team, Outside Students: 400rs/Team [Note: Payments will be collected offline, on campus.]",
      ...
      "structure": "MCKVIE Students: 100rs/Team, Outside Students: 400rs/Team [Note: Payments will be collected offline, on campus.]",
    "poster": require("./Line Follower Poster.png"),
